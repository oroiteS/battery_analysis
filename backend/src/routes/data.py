...
# --- Schemas ---
# [DEPRECATED - MVP] DataUploadResponse - Not used in MVP (no user uploads)
...
# --- Endpoints ---
# [DEPRECATED - MVP] Upload endpoint - Not used in MVP (no user uploads)
# @router.post(
...
# [DEPRECATED - MVP] Get upload status endpoint - Not used in MVP
...
# [DEPRECATED - MVP] List uploads endpoint - Not used in MVP
...
def list_datasets(
    ...
    # MVP: 仅返回内置数据集
    query = query.filter(Dataset.source_type == "BUILTIN")
...
# [DEPRECATED - MVP] Delete dataset endpoint - Not used in MVP (no user uploads, built-in datasets cannot be deleted)
